...
$p = new Page("web", "public", "page_admin_login");
...
if ($view == "index") {
  ...
  $p = new Page("web", "admin", "page_admin_login");
  $view = "index";
}
...
///////////////////////////////////////////////////
switch($view) {
  case "index": include($path->getFilePath("template_admin_login_index")); break;
  case "login_index": include($path->getFilePath("template_admin_login_form")); break;
