...
switch ($view) {
  case "index": include_once($path->getFilePath("template_monitor_archive_index")); break;
  case "gamelist": include_once($path->getFilePath("template_monitor_archive_gamelist")); break;
  case "stats": include_once($path->getFilePath("template_monitor_archive_stats")); break;
