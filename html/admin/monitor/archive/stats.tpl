...
if (!$hometime_possession) $hometime_possession = "0:00";
if (!$awaytime_possession) $awaytime_possession = "0:00";
if (!$homedefense[tackles][sackyds]) $homedefense[tackles][sackyds] = 0;
if (!$awaydefense[tackles][sackyds]) $awaydefense[tackles][sackyds] = 0;
if (!$homedefense[tackles][tflyds]) $homedefense[tackles][tflyds] = 0;
if (!$awaydefense[tackles][tflyds]) $awaydefense[tackles][tflyds] = 0;
if (!$homedefense[fumbles][forced]) $homedefense[fumbles][forced] = 0;
if (!$awaydefense[fumbles][forced]) $awaydefense[fumbles][forced] = 0;
if (!$homedefense[fumbles][recovered]) $homedefense[fumbles][recovered] = 0;
if (!$awaydefense[fumbles][recovered]) $awaydefense[fumbles][recovered] = 0;
if (!$homedefense[fumbles][yds]) $homedefense[fumbles][yds] = 0;
if (!$awaydefense[fumbles][yds]) $awaydefense[fumbles][yds] = 0;
if (!$homedefense[inter][num]) $homedefense[inter][num] = 0;
if (!$awaydefense[inter][num]) $awaydefense[inter][num] = 0;
if (!$homedefense[inter][yds]) $homedefense[inter][yds] = 0;
if (!$awaydefense[inter][yds]) $awaydefense[inter][yds] = 0;
$p->startMonitorTemplate();
?>
<center>
<table width = "60%" align=center><tr><td width="30"><a  href="<?=$path->getPath("page_playerstats")?>?gameid=<?=$gameid?>&teamid=<?=$awayid?>"><?=$awayacronym?> Players</a>&nbsp;</td>
       <td width="30"> <u><?=$season?></u>&nbsp;</td>
       <td width="30"> <a  href="<?=$path->getPath("page_playerstats")?>?gameid=<?=$gameid?>&teamid=<?=$homeid?>"><?=$homeacronym?> Players</a></td>
        <br></tr></table>
</center>
<center>
<table width="60%" align=center>
  <tr>
    <td width="30" align=center><img class="teamlogo" src="<?=$path->getPath("image_logo_root") . $awaylogo?>"></td>
    <td><center>vs.</center></td>
    <td width="30" align=center><img class="teamlogo" src="<?=$path->getPath("image_logo_root") . $homelogo?>"></td>
  </tr>
</table>
</center>
<center>
<table width="92%" cellpadding=1 cellspacing=3 > 
  <tr>
  ...
  <tr>
    ...
    <td align=center><? if ($awayyards[passing][completions]) {
             printf("%.1lf", ($awayyards[passing][yards] / $awayyards[passing][completions]));
           } else {
             echo "0";
           }
        ?></td>
    <td align=center><? if ($homeyards[passing][completions]) {
  ...
  <tr>
    ...
    <td align=center><? if ($awayyards[rushing][attempts]) {
             printf("%.1lf", ($awayyards[rushing][yards] / $awayyards[rushing][attempts]));
           } else {
             echo "0";
           }?></td>
    <td align=center><? if ($homeyards[rushing][attempts]) {
