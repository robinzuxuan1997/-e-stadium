...
<body onLoad="swStart('beg2','+');setInterval(function(){rotate()},20000);initLinks()">
	...
	<table border="1" cellpadding="0" cellspacing="0" width="120" class="teamscore">
	 ...
	 <tr>
	  <td align="center">
		...
		<image class="possession hidden" width="16" height="16" src="PossessionIcon.png"/>
	  </td>
	  <td align="center">
...
<!--<div class="page-list-indicators"></div>-->
	...
	<div id="dash-nav">
		<ul class="dash-nav-list">
			<li id="dashnavone"><a href="#gamestats" class="dncp">Game Status</a></li>
			<li id="dashnavtwo"><a href="#scoring" class="dummy" onClick="swReset('beg2');swStart('beg2','+');">Scoring Summary</a></li>
			<li id="dashnavthree"><a href="#teamstats" class="dummy">Team Stats</a></li>
